...
public class CollectionsBillPaymentReconFileBatch extends BatchUtils {
	
	
	JavaUtils javaUtils = new JavaUtils();
	DBUtils dbUtils = new DBUtils();
	ApiUtils apiUtils = new ApiUtils();
	String workbook = "workbook", testDataSheetName = "CollectionsBillPaymentReconFile", fileName, vanNumber, batchSheetName, batchConfigSection="setorganizationattributes";
